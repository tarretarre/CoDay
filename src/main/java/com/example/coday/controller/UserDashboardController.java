...
public class UserDashboardController {
    ...
    public String showDashboard(@AuthenticationPrincipal CustomUserDetails currentUser, Model model) {
        ...
        Optional<Visit> currentVisitOpt = visitRepo.findFirstByUserAndCheckOutTimeIsNullOrderByCheckInTimeDesc(user);
        Visit currentVisit = currentVisitOpt.orElse(null);

        List<Visit> rawVisits = visitRepo.findByUserOrderByCheckInTimeDesc(user);
